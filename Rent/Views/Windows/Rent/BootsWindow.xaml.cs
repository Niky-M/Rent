...
//namespace Rent.Views.Windows.Rent
//{

//    public partial class BootsWindow : Window, INotifyPropertyChanged
//    {
//        private ObservableCollection<Parameter> parametersCollection;
...
//            int bootParameter = Convert.ToInt32($"Select ParameterId from Equipment where ParameterName = Boot");

//            var db = new SkiRent03Context();
//            var boot = new Parameter()
//            {
//                ParameterId = bootParameter,
...
//        {
//            DataContext = this;
//            using var context = new SkiRent03Context();
//            Parameters = new ObservableCollection<Parameter>(context.Parameters
